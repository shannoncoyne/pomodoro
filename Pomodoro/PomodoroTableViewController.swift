...
class PomodoroTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("pomodoro cell", forIndexPath: indexPath) as! UITableViewCell
        ...
        case Identifiers.showSettingsSegue:
            if let navController = segue.destinationViewController as? UINavigationController {
                if let settingsVC = navController.viewControllers.first as? SettingsViewController {
                    settingsVC.model = settingsModel
                }
            }
            else {
                assertionFailure("destination of segue was not a SettingsViewController")
            }
        default:
